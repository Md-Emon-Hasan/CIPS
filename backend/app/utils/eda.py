...
def analyze_teams_per_season(match_df):
    ...
    try:
        ...
        plt.title(
            "Number of teams participated each season", fontsize=18, fontweight="bold"
        )
...
def analyze_winner_of_toss_each_season(match_df):
    ...
    try:
        ...
        plt.show(wot)
        logging.info(
            "Teams who won after winning the toss each season analysis completed."
        )
    except Exception as e:
...
if __name__ == "__main__":  # pragma: no cover
    from app.services.data_collection import load_data
